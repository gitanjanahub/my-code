    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-3 align-items-center">
                <div class="col-sm-6">
                    <h1 class="text-primary">Add Stock for {{ $product->name }}</h1>
                </div>
            ...
            <form wire:submit.prevent="save">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Define Stock Quantities</h3>
                    </div>
                    <div class="card-body">
                        <!-- Iterate over rows -->
                            ...
                            <div class="row align-items-center mb-2">
                                ...
                                @foreach ($productAttributes as $attributeName => $values)
                                    <div class="col-md-3">
                                        ...
                                        <select wire:model="rows.{{ $index }}.selectedAttributes.{{ $attributeName }}" class="form-control">
